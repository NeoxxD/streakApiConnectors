...
function invoke(globals, actionName, data, authenticationType, LOG, callback) {
    ...
    streak.Boxes.getAll().then(function (info) {
        LOG.info(info);
        var data = '';
        ...
        var error = RESPONSE(null,
            {
                message: 'Could not get all boxes a user has access to, make sure your api-key, pipeline-key and stage-key is correct',
